...
prompt_object = data.get("microsoft_adapter_prompt_object")
if not isinstance(prompt_object, str) or not prompt_object.strip():
    fail("microsoft_adapter_prompt_object vacío o ausente", data)
if not prompt_object.endswith("/microsoft_adapter_prompt.json"):
    fail("microsoft_adapter_prompt_object con sufijo inesperado", data)
...
prompt = data.get("microsoft_adapter_prompt")
